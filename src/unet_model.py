...
class Unet_lite(nn.Module): #a smaller version where the bottleneck has 512 channels instead of 1024
    def __init__(self, in_channels, out_channels):
        super().__init__()

        self.enc1 = ConvBlock(in_channels, 64) #the nn.Conv2d is specified with kernel_size = 3, padding = 1
        self.enc2 = ConvBlock(64, 128)
        self.enc3 = ConvBlock(128, 256)
